...
// CHEAT
static TAutoConsoleVariable<float> CVarENMSeekerDirectSeekSampleInterval(
	TEXT("enm.Seeker.DirectSeekSampleInterval"),
	0.5f,
	TEXT("When seeking player directly, how frequently to store the waypoints."),
	ECVF_Default
);
